      ...
      <div class="blogs-container" v-if="blogsExist">
        <div class="single-blog-box" v-for="blog in blogs" :key="blog.id">
          <div class="blog-box-div"><!--@click="openSelectedBlog(blog.id)"-->
            ...
            <div class="actions">
              <span class="dropdown-arrow-svg" data-toggle="dropdown" role="button" aria-expanded="false">
                <svg
                  version="1.1"
                  id="Capa_1"
              ...
              <div class="options-card dropdown-menu dropdown-menu-notifications">
                <ul>
                  <li v-if="user.id === blog.user.id" @click="editPost(blog)">
                    <i class="fa fa-pencil"></i>
                    <span>Edit</span>
                  </li>
                  <li v-if="user.id === blog.user.id" @click="deletePost(blog.id)">
                    <i class="fa fa-trash-o"></i>
                    <span>Delete</span>
                  </li>
                  <li @click="sharePost(blog)">
        ...
        <div class="sticky-btn">
          <button @click="openPostModal()" class="add-new-post-btn">
      ...
      <div class="no-blogs" v-else>
        <div class="no-blogs-svg">
          <svg
            ...
            width="100%"
            height="100%"
            viewBox="0 0 1079.94368 779.70903"
          >
            ...
            <path
              ...
              fill="#2f2e41"
            />
            <circle cx="535.12165" cy="151.0339" r="52" fill="#6c63ff" />
        ...
        <div class="no-blogs-span text-center">
      ...
      <form @submit.prevent="editmode ? updateArticle() : saveArticle()">
        <div class="form-group">
          ...
          <input
            ...
            name="blog_title"
            class="form-control"
            :class="{ 'is-invalid': form.errors.has('blog_title') }"
            autocomplete="off"
          />
        ...
        <div class="form-group">
          ...
          <textarea
            v-model="form.blog_post"
            name="blog_post"
            cols="30"
            rows="10"
            class="form-control"
            :class="{ 'is-invalid': form.errors.has('blog_post') }"
          ></textarea>
